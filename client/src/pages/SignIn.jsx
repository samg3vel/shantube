...
function SignIn(props) {
    ...
    const handleSignUp = async (e) => {
        ...
        try {
            ...
            console.log(res.data);
            const resSignIn = await axios.post("auth/signin", { name: inputs.name, password: inputs.password });
            dispatch(loginSuccess(resSignIn.data));
            navigate("/");
        } catch (error) {
            dispatch(loginFailed());
        }
    ...
    return (
        <Container>
            <Wrapper>
                <Title>Sign in</Title>
                <SubTitle>to continue to Shan video</SubTitle>
                ...
                <Title>Or</Title>
                <Input placeholder='username' onChange={(e) => handleChange("name", e.target.value)} />
